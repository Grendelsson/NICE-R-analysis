...
cids <- google_analytics(
	...
	dim_filter("ga:dimension11", "EXACT", "cookie")
    ),
    operator = "AND"),
    metrics = "sessions",
    dimensions = "clientId",
...
write.csv(hits[c("sessionId","activityTime","source","medium","channelGrouping","campaign","landingPagePath","activityType","pagePath","pageTitle","has_goal","eventCategory","eventAction","eventLabel","eventValue","eventCount","id.x","goalIndex","goalName","goalCompletionLocation","eventseq","deviceCategory","platform","dataSource","sessionDate")],"full_hst_hits_storage_filter_June-21.csv")